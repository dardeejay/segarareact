            ...
            <div className="RoomsContainerText col-md-6 order-sm-2 order-lg-1 text-center">
              <div className="row">
                ...
                <div className="col-md-12 px-5">
                  <p>
                    A grandiose abode inside Subic Bay that offers 10 luxurious
                    villas for a peaceful accommodation. An undisturbed boutique
                    hotel that provides superb personalized service and
                    tremendous amenities.
                  </p>
                </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-12 px-5">
                  <p>
                    ...
                    will surely make your stay memorable and truly revitalizing.
                  </p>
                </div>
              </div>
              <div className="col-md-12 px-5 text-center">
              ...
              <div className="row">
                ...
                <div className="col-md-12 px-5 text-center">
                  <p>
                    ...
                    Bay. Offering more than 40 rooms, Segara Residencias is very
                    ideal for families, friends, and other big groups.
                  </p>
                </div>
              </div>
              <div className="col-md-12 px-5 text-center">
